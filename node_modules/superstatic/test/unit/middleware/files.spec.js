...
describe('static server with trailing slash customization', function() {
  ...
  beforeEach(function() {
    ...
    fs.outputFileSync('.tmp/foo/csr.html', 'foo/csr.html content', 'utf8');
  ...
  it('serves a directory index file', function(done) {
    fs.outputFileSync('.tmp/csr.html', 'test', 'utf8');
  ...
  it('does not redirect the root url because of the trailing slash', function(done) {
    fs.outputFileSync('.tmp/csr.html', 'an actual index', 'utf8');
  ...
  [
    {
      ...
      tests: [
        ...
        {path: '/foo/', wantContent: 'foo/csr.html content'},
        ...
        {path: '/foo/csr.html', wantContent: 'foo/csr.html content'},
        {path: '/foo/csr.html/', wantNotFound: true}
      ]
    },
    {
    ...
    },
    {
      ...
      tests: [
        ...
        {path: '/foo/csr.html', wantRedirect: '/foo'},
        {path: '/foo/csr.html/', wantNotFound: true}
      ]
    },
    {
