...
var INDEX_TEMPLATE = fs.readFileSync(__dirname + "/../../../templates/init/hosting/csr.html", "utf8");
...
module.exports = function (setup, config) {
    ...
    return prompt(setup.hosting, [
        ...
        },
        {
            ...
            type: "confirm",
            default: false,
            message: "Configure as a single-page app (rewrite all urls to /csr.html)?",
        },
    ]).then(function () {
        ...
        if (setup.hosting.spa) {
            setup.config.hosting.rewrites = [{ source: "**", destination: "/csr.html" }];
        ...
        return next
            ...
            return config.askWriteProjectFile(setup.hosting.public + "/csr.html", INDEX_TEMPLATE.replace(/{{VERSION}}/g, response.body.current.version));
        });
    });
};
